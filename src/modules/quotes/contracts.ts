/**
 * Wingman quote contracts — host copy.
 *
 * MIRRORED FILE: container/agent-runner/src/quotes/contracts.ts (container tree) must stay
...
export type EscalationReason = 'discount_exceeds_limit' | 'off_card' | 'low_confidence' | 'total_exceeds_limit';
...
export type QuoteStatus = 'auto_sent' | 'pending_approval' | 'approved' | 'rejected' | 'superseded';
